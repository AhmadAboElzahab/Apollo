...
router.post('/', upload.single("image"), async (req, res) => {
    ...
    const convertedImagePath = path.join(__dirname, "../../uploads/artworks/", "converted_" + fileName);
...
router.patch('/:id', async (req, res) => {
    ...
    try {
        ...
        res.json({ message: "Artwork updated successfully", artwork: artworkToUpdate }).status(200);
    } catch (err) {
