            ...
            <Boundary labels={['parallel-routes/page.tsx']} size='small'>
              <div className='prose prose-sm prose-invert max-w-none'>
                ...
                <ul>
                  ...
                  <li>
                    Try using the tabs in one parallel route to navigate. Notice the URL changes but
                    the unaffected parallel route is preserved.
                  </li>
                  <li>
                  ...
                  <li>
                    Try navigating to a tab in one parallel route and refreshing the browser. Notice
                    you can choose what UI to show parallel routes that don&apos;t match the initial
                    URL.
                  </li>
                </ul>
              </div>
